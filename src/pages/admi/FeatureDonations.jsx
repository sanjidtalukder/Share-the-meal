...
const FeatureDonations = () => {
  ...
  useEffect(() => {
    axios.get("https://share-the-meal-server-sigma.vercel.app/donations?status=Verified")
  ...
  const handleFeature = async (id) => {
    try {
      setFeaturingId(id);
      await axios.post(`https://share-the-meal-server-sigma.vercel.app/api/featured`, { donationId: id });
