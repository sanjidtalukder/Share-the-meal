...
const ManageDonations = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://share-the-meal-server-blond.vercel.app/api/donations?status=Pending", {
  ...
  const handleVerify = async (id) => {
    try {
      setProcessingId(id);
      await axios.put(`https://share-the-meal-server-blond.vercel.app/api/donations/verify/${id}`, null, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleReject = async (id) => {
    try {
      setProcessingId(id);
      await axios.put(`https://share-the-meal-server-blond.vercel.app/api/donations/reject/${id}`, null, {
        headers: { Authorization: `Bearer ${token}` },
      });
