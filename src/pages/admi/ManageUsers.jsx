...
const ManageUsers = () => {
  ...
  useEffect(() => {
    axios.get("https://share-the-meal-server-blond.vercel.app/api/users/all")
      .then(res => {
        setUsers(res.data);
        setLoading(false);
      })
  ...
  const updateRole = async (id, role) => {
    try {
      await axios.patch(`https://share-the-meal-server-blond.vercel.app/api/users/${id}/role`, { role });
  ...
  const deleteUser = async (id) => {
    ...
    try {
      await axios.delete(`https://share-the-meal-server-blond.vercel.app/api/users/${id}`);
