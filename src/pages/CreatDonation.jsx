...
const CreateDonation = () => {
  ...
  useEffect(() => {
    if (user?.email) {
      axios
        .get(`https://share-the-meal-server.onrender.com/api/users?email=${user.email}`)
        .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://share-the-meal-server.onrender.com/api/donations", postData, {
        headers: {
