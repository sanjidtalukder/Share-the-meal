...
const TransactionHistory = () => {
  ...
  if (!user?.email) {
    return <p className="text-center p-4 text-gray-500">Please login to see your transactions.</p>;
  }

  if (loading) {
    return <p className="text-center p-4 text-gray-500">Loading transactions...</p>;
  }
