...
const MyRequests = () => {
  ...
  const fetchRequests = async () => {
    ...
    try {
      const res = await axios.get(`https://share-the-meal-server-sigma.vercel.app/api/requests?charityEmail=${user.email}`);
  ...
  const handleCancel = async (id) => {
    ...
    try {
      await axios.delete(`https://share-the-meal-server-sigma.vercel.app/api/requests/${id}`);
      fetchRequests();
    } catch (err) {
